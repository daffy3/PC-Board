...
class ArticleServiceTest {
    ...
    @Test
    void givenSearchParameters_whenSearchingArticles_thenReturnArticles() {
        // Given
    ...
    void givenArticleInfo_whenSavingArticle_thenSavesArticle() {
        ...
        // When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "daffy3", "title", "content", "#java"));

        // Then
        then(articleRepository).should().save(any(Article.class)); // save를 한 번 호출했는가를 검사
    }
    ...
    void givenArticleIdAndModifiedInfo_whenUpdatingArticle_thenUpdatesArticle() {
        ...
        // When
        sut.updataArticle(1L, ArticleUpdateDto.of("title", "content", "#java"));
